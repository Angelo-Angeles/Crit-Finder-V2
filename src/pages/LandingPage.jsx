...
import { Swords, Users, MessageSquare, Shield, Scroll, Search } from "lucide-react";

export function LandingPage() {
  return (
    <div className="min-h-screen bg-linear-to-b from-stone-950 via-stone-900 to-amber-950">
        ...
        <div className="relative">
          <nav className="px-6 py-4">
            <div className="max-w-7xl mx-auto flex items-center justify-between">
              ...
              <Link
                to="/login"
                className="px-6 py-2 bg-amber-600 hover:bg-amber-700 text-white rounded-md transition-colors"
              >
                Login / Sign Up
              </Link>
            </div>
          ...
          <section className="px-6 py-20 text-center">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  to="/quest-board"
                  className="px-8 py-4 bg-amber-600 hover:bg-amber-700 text-white text-lg rounded-md transition-colors flex items-center justify-center gap-2"
                >
                ...
                <Link
                  to="/login"
                  className="px-8 py-4 bg-stone-800 hover:bg-stone-700 text-amber-100 text-lg rounded-md border-2 border-amber-700 transition-colors"
                >
                  Create Account
                </Link>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="bg-stone-800/50 border-2 border-amber-800/50 rounded-lg p-6 hover:border-amber-700 transition-colors">
                  ...
                  <p className="text-amber-200/70">
                    Explore our quest board to find groups looking for players or post your own quest
                    seeking adventurers for your campaign.
                  </p>
                </div>
                ...
                <div className="bg-stone-800/50 border-2 border-amber-800/50 rounded-lg p-6 hover:border-amber-700 transition-colors">
                  ...
                  <p className="text-amber-200/70">
                    Use our messaging system to communicate with potential party members, discuss
                    campaign details, and schedule sessions.
                  </p>
                </div>
                ...
                <div className="bg-stone-800/50 border-2 border-amber-800/50 rounded-lg p-6 hover:border-amber-700 transition-colors">
                  ...
                  <p className="text-amber-200/70">
                    Build your ideal adventuring party and begin your epic D&D journey together.
                    Roll for initiative!
                  </p>
                </div>
              </div>
          ...
          <section className="px-6 py-20">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-amber-200/80 mb-8">
                Whether you're a seasoned dungeon master or a first-time player,
                Crit Finder helps you find the perfect group for your next campaign.
              </p>
              <Link
                to="/login"
                className="inline-block px-8 py-4 bg-amber-600 hover:bg-amber-700 text-white text-lg rounded-md transition-colors"
              >
                Get Started Now
              </Link>
            </div>
