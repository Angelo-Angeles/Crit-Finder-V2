  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 h-[calc(100vh-5rem)]">
      <div className="bg-stone-800/80 border-4 border-amber-700 rounded-lg shadow-2xl h-full flex overflow-hidden">
        {/* Sidebar */}
        <div className="w-1/3 border-r-2 border-amber-800/50 flex flex-col bg-stone-900/50">
          <div className="p-4 border-b border-amber-800/50">
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full pl-9 pr-4 py-2 bg-stone-950 border border-amber-800 rounded-md text-amber-100 text-sm focus:outline-none focus:ring-2 focus:ring-amber-600" 
              />
            </div>
          </div>
          <div className="flex-1 overflow-y-auto">
            <button className="w-full p-4 flex items-start gap-3 border-b border-amber-800/30 hover:bg-stone-800 transition-colors text-left bg-stone-800/80 border-l-4 border-l-amber-500">
              ...
              <div className="flex-1 overflow-hidden">
                <div className="flex justify-between items-baseline mb-1">
                  ...
                  <span className="text-xs text-amber-400/60 shrink-0">10 min ago</span>
                </div>
                <p className="text-sm text-amber-200/70 truncate">Thanks! I'll join your Friday session.</p>
              </div>
            </button>
          </div>
        </div>
        ...
        <div className="flex-1 flex flex-col bg-stone-900/20">
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            <div className="flex justify-start">
              <div className="max-w-[70%]">
                <div className="p-3 rounded-2xl rounded-tl-sm bg-stone-800 text-amber-100 border border-amber-800/50">
                  <p>Hi! I saw your post about Lost Mines of Phandelver. Is there still room?</p>
                </div>
              </div>
            </div>
            <div className="flex justify-end">
              <div className="max-w-[70%]">
                <div className="p-3 rounded-2xl rounded-tr-sm bg-amber-600 text-white">
                  <p>Yes! We're looking for a rogue actually. Have you played 5e before?</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="p-4 border-t border-amber-800/50 bg-stone-900/80">
            <form onSubmit={handleSendMessage} className="flex gap-2">
              ...
              />
              <button type="submit" className="px-6 py-2 bg-amber-600 hover:bg-amber-700 text-white rounded-md transition-colors flex items-center gap-2">
